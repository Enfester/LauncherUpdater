...
public class Launch extends Application {
    ...
    public void start(Stage stage) throws Exception {
        stage.getIcons().add(new Image(Launch.class.getResourceAsStream("/ru/enfester/laun/logo.png")));
        Parent root = FXMLLoader.load(getClass().getResource("/ru/enfester/laun/FXMLDocument.fxml"));
